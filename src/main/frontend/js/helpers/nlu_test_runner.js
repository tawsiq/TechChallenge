// Simple Node runner to smoke-test the browser NLU module.
// It mocks a minimal `window` and `Engine.getConditionMeta` used by the NLU file,
// then requires the NLU file (which attaches `window.NLU`) and runs a set of
// representative test phrases.

global.window = {};
// Minimal mock of Engine.getConditionMeta to provide known medication names/examples
...
// Load the NLU file (it attaches window.NLU)
require('./nlu.js');
